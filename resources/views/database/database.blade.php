            ...
            <nav class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
                ...
                <div class='collapse navbar-collapse navbar-hamburger-delicious'>
                    <ul class='nav navbar-nav side-nav fadeInLeft'>
                        ...
                        <li class='active docs'><a href='#docs'><i class='fa fa-lg fa-user'></i>Database
                                Pakar</a></li>
                        <li class='admin'><a href='#admin'><i class='fa fa-lg fa-user'></i>Database User</a></li>
                        <li class='divider'>
                            <hr>
                        </li>
                        <li class='person-lookup'><a href='#personLookup'><i class='fa fa-lg fa-phone-square'></i>Person
                                Lookup</a>
                        </li>
                                ...
                                <table data-toggle="table" data-show-toggle="true" data-show-columns="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="Alamat Instansi">Alamat Instansi</th>
