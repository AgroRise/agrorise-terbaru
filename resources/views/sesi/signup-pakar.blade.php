        ...
        <div class="wrapper fadeInDown">
            ...
            <div id="formContent">
                ...
                <form action="/signup-pakar" method="post">
                    ...
                    @enderror
                    <input type="password" id="password" class="fadeIn third pass_show @error('password') is-invalid @enderror"
                    ...
                    @enderror
                    <input type="password" id="password" class="fadeIn third pass_show" name="password_confirmation"
