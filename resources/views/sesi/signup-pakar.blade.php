...
<div class="bgimg">
    <div class="wrapper fadeInDown">
        ...
        <form action="/signup-pakar" method="post">
            ...
            @enderror
            <input type="username" id="username" class="fadeIn second @error('username') is-invalid @enderror" name="username" placeholder="Username" required value="{{ old('username') }}">
            @error('username')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            ...
            @enderror
            <input type="text" id="alamat" class="fadeIn third @error('alamat') is-invalid @enderror" name="alamat" placeholder="Alamat" required>
            @error('alamat')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            @enderror
            <input type="text" id="pendidikan_terakhir" class="fadeIn second @error('pendidikan_terakhir') is-invalid @enderror" name="pendidikan_terakhir" placeholder="Pendidikan Terakhir" required>
            @error('pendidikan_terakhir')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            @enderror
            <input type="text" id="pekerjaan" class="fadeIn third @error('pekerjaan') is-invalid @enderror" name="pekerjaan" placeholder="Pekerjaan" required>
            @error('pekerjaan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            @enderror
            <input type="text" id="instansi" class="fadeIn third @error('instansi') is-invalid @enderror" name="instansi" placeholder="Instansi" required>
            @error('instansi')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            @enderror
            <input type="text" id="alamat_instansi" class="fadeIn second @error('alamat_instansi') is-invalid @enderror" name="alamat_instansi" placeholder="Alamat Instansi" required>
            @error('alamat_instansi')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            @enderror
            <label>CV (format dalam bentuk .pdf)<br><input type="file" id="cv" class="fadeIn third" name="cv" placeholder="CV"></label>
            <label>Sertifikat (format dalam bentuk .pdf)<br><input type="file" id="sertifikat" class="fadeIn third" name="sertifikat" placeholder="Sertifikat"></label>
