                      ...
                      <div class="form h-100 contact-wrap p-5">
                        ...
                        <nav class="nav2 mt-3">
                          <form class="container-fluid justify-content-center">
                            ...
                            <a href="/pupuk-kotoran-ayam"><button class="btn btn-outline-success me-2 " type="button">Kotoran  Ayam</button></a>
                            <button class="btn btn-outline-success me-2 :hover active" type="button">SP-36</button>
                          </form>
                        </nav>
