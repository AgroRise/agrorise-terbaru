        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="bgimg">
                <div class="wrapper fadeInDown">
                    ...
                    <!-- Login Form -->
                    <form>
                        <input type="text" id="signup" class="fadeIn second" name="signup" placeholder="Nama">
                        <input type="text" id="signup" class="fadeIn second" name="signup" placeholder="Email">
                        <input type="text" id="password" class="fadeIn third" name="signup" placeholder="Alamatt">
                        <input type="text" id="password" class="fadeIn third" name="signup" placeholder="Password">
